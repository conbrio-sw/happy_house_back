...
//			s.length();
			...
			for (MultipartFile partFile : fileList) {
				...
				//File destFile2 = new File(uploadPath2 + File.separator + uploadFolder + File.separator + savingFileName);
				System.out.println("destfile1 : " + destFile);
				//System.out.println("destfile2 : " + destFile2);
				System.out.println(uploadPath + File.separator + uploadFolder + File.separator + savingFileName);
				partFile.transferTo(destFile);
				//partFile.transferTo(destFile2);
